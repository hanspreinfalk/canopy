//
//  CustomTranscriptionProvider.swift
//  canopy
//
...
protocol CustomStreamingTranscriptionSession: AnyObject {
...
protocol CustomTranscriptionProvider {
...
enum CustomTranscriptionProviderFactory {
    ...
    static func makeDefaultProvider() -> any CustomTranscriptionProvider {
        let provider = resolveProvider()
        print("🎙️ Transcription: using \(provider.displayName)")
        return provider
    }

    private static func resolveProvider() -> any CustomTranscriptionProvider {
