...
final class OpenAIAudioTranscriptionProvider: CustomTranscriptionProvider {
...
private final class OpenAIAudioTranscriptionSession: CustomStreamingTranscriptionSession {
    ...
    private let stateQueue = DispatchQueue(label: "com.hanspreinfalk.openai.transcription")
    private let audioPCM16Converter = CustomPCM16AudioConverter(
    ...
    private func transcribeBufferedAudio(_ bufferedPCM16AudioData: Data) async {
        ...
        let wavAudioData = CustomWAVFileBuilder.buildWAVData(
